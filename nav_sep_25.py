...
current_month = datetime(2025, 9, 1).strftime("%B")
report_year = datetime(2025, 9, 1).year

# Filtered df where 'Date of Activity:' is in September
...
df = df[(df['Date of Activity'].dt.month == 9) & (df['Date of Activity'].dt.year == 2025)]
